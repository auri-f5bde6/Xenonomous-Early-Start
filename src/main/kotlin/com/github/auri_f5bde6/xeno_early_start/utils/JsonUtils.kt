...
object JsonUtils {
    fun getItem(obj: JsonObject, key: String): Item? {
        val value = getIdentifier(obj, key) ?: return null
        val item = ForgeRegistries.ITEMS.getValue(value) ?: throw JsonSyntaxException(
    ...
    fun getIdentifier(obj: JsonObject, key: String): Identifier? {
        val value = getString(obj, key) ?: return null
        val ident = Identifier.tryParse(value) ?: throw JsonSyntaxException(
