...
public class TextVisitFactoryMixin {
    ...
    private static boolean allowP(Object left, Object right, Operation<Boolean> original, @Local(ordinal = 1) char colourCode) {
    ...
    private static Style replaceWithPink(Style instance, Formatting textColor, Operation<Style> original, @Local(ordinal = 1) char colourCode) {
        if (colourCode == 'p') {
